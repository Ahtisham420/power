<div class="card-body">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" required id="blog_title" placeholder="Enter Titltle" aria-describedby="blog_title_help" name='title'
            value="{{old("title",$post->title)}}">
        <small id="blog_title_help"
            class="form-text text-muted">{{ __('admin/pages/blog_post_list.blog_post_title') }}</small>
    </div>

    <div class="form-group">
        <label for="blog_subtitle">{{ __('admin/pages/blog_post_list.subtitle') }}</label>
        <input type="text" class="form-control" id="blog_subtitle" placeholder="Enter Subtitle" aria-describedby="blog_subtitle_help" name='subtitle'
        ...
        <div class="form-group">
            <label for="blog_author_name">{{ __('admin/pages/blog_post_list.author_name') }}</label>
            <input type="text" class="form-control" id="blog_author_name" placeholder="Author Name" aria-describedby="blog_author_name_help" name='author_name'
                   value='{{old("author_name",$post->auhtor_name)}}'>
            <small id="blog_author_name_help"
                   class="form-text text-muted">{{ __('admin/pages/blog_post_list.post_author_name_description') }}</small>
        </div>
    ...
    <div class='row'>
        ...
        <div class='col-sm-12 col-md-4'>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="blog_slug" placeholder="Enter Slug" aria-describedby="blog_slug_help" name='slug'
    ...
    <div class="form-group">
        ...
        <textarea style='min-height:600px;' class="form-control" id="blog_post_body"
            aria-describedby="blog_post_body_help" placeholder="Enter Blog Body" name='post_body'>{{old("post_body",$post->post_body)}}</textarea>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="Enter View File" id="blog_use_view_file" aria-describedby="blog_use_view_file_help"
    ...
    <div class="form-group">
        ...
        <input class="form-control" id="blog_seo_title" aria-describedby="blog_seo_title_help" name='seo_title'
            tyoe='text' placeholder="Enter Seo Title" value='{{old("seo_title",$post->seo_title)}}'>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" id="blog_meta_desc" aria-describedby="blog_meta_desc_help" placeholder="Meta Description"
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" id="blog_short_description" aria-describedby="blog_short_description_help" placeholder="Short Description"
    ...
    {{--<div class="form-group">--}}
        ...
        {{--<input class="form-control" type="text" placeholder="Posts Tags" name="post_tags" class="tags-input" id="tags-input"--}}
    ...
    <div class="bg-white pt-4 px-4 pb-0 my-2 mb-4 rounded border">
        ...
        <div class="form-group mb-4 p-2">
            ...
            <input class="form-control"  type="file" name="feature_image" onchange="readURL(this);" id="blog_feature_img"
