...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">
        <a href="{{ route('homeImage.create') }}">Create Home Image</a>
    </li>
</ol>
<!-- Breadcrumb-->
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form method="post" action="{{route('homeImage.store')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="card-header">
                        <strong>Create Home Image</strong>
                        {{--<small>Form</small>--}}
                    </div>


                    @include("home-image.form", ['post' => new App\HomeImage()])
    ...
    <div class="card-footer">
        ...
        <a class="btn btn-sm btn-danger" type="reset" href="{{route('homeImage.index')}}">
