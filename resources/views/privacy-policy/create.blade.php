...
<ol class="breadcrumb">
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/home') }}">Add Privacy Policy</a>
    </li>
    <li class="breadcrumb-item active">
        <a href="{{ route('privacy-policy.create') }}">Add Privacy Policy</a>
    </li>
</ol>
<!-- Breadcrumb-->
<div class="container-fluid">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <form method="post" action="{{route('privacy-policy.store')}}" enctype="multipart/form-data">
                    ...
                    @include("privacy-policy.form", ['post' => new App\PrivacyPolicy()])
    ...
    <div class="card-footer">
        ...
        <a class="btn btn-sm btn-danger" type="reset" href="{{route('privacy-policy.index')}}">
