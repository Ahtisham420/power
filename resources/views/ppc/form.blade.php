    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-6">
            ...
            <div class="form-group">
                <label for="blog_title">Subject</label>
                <input type="text" class="form-control" required="" id="blog_title" placeholder="Enter Titltle" aria-describedby="blog_title_help" name="subject" value="{{old("post_body",$post->subject)}}">
                <small id="blog_title_help" class="form-text text-muted">Title</small>
            </div>
...
<div class="form-group">
        <label for="blog_post_body">Mail Body
        ...
        <textarea style='min-height:600px;' class="form-control" id="blog_post_body"
            aria-describedby="blog_post_body_help" placeholder="Enter Blog Body" name='mail_body'>{{old("post_body",$post->mail_body)}}</textarea>
