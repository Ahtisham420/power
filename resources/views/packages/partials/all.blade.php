<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('all-packages-search')}}">
                <div class="row">

                    <div class="col-md-7">
                        <input class="form-control js-filter-search" name="filter_search" placeholder="Name / Tagline / Price / Duration" required>
                    </div>
                    <div class="col-md-3">
                        <button class="btn btn-primary fa fa-search js-filter-search-btn" type="submit" title="{{ __('admin/pages/users_list.search') }}"></button>
                        <button class="btn btn-success fa fa-refresh" title="Refresh"  onclick="location.href='{{route('all-packages')}}'"></button>
