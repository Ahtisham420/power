                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="form-group col-sm-5">
                                                    ...
                                                    <input class="form-control" onchange="readURL(this);" id="avatar_file" name="avatar_file"
                                                           type="file">
                                                </div>
                                            ...
                                            <div class="form-group col-sm-12">
                                                ...
                                                <textarea class="form-control" id="address" name="address" rows="4"
                                                    required placeholder="Address..">{{ !empty($results) ? $results->address : old('address') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
