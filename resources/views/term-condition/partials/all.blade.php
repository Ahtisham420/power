    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> All Term & condition
                {{--<a href="{{ route('term-condition.create') }}"--}}
                ...
                <table class="table table-responsive-sm table-bordered" id="posts-table">
                    ...
                    <tbody>
                        ...
                        <td>
                                ...
                                <a class="btn btn-sm btn-primary" href="{{route('term-condition.edit', $post->id)}}"><i
                                        class="fa fa-pencil fa-1x-size"></i></a>
                                {{--<a href="javascript:void(0)" class="btn btn-block btn-danger col action-btn js-del-btn"--}}
                                    {{--data-route="term-condition.index" data-model="TermCondition" data-id="{{$post['id']}}">--}}
