...
<div class="container">
  ...
  <div class="row singleEvent mt-3 mb-3">
    <div class="col-12 col-sm-6 event-map pr-0">
      <iframe src="https://www.google.com/maps/embed/v1/place?q={{$event->map_lat}},{{$event->map_lng}}&amp;key=AIzaSyAddbxUhXJYrPqsX24kbEhFR1cJg37U2vA" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
    </div>
