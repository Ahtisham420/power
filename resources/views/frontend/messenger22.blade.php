...
<div class="container careers-body  messengerscreen">
    <div class="row messenger pt-2 mt-3">
        <div class="col-12 col-sm-4 leftsidebar " id="leftsidebar">
            ...
            <div class="row user-message-list" id="user-message-list">
...
@if(!empty($result) && count($result) > 0)
    @foreach($result as $r)
                        @if($r->from->id==session('userDetails')->id)
                            ...
                            @php $name=$r->to->first_name @endphp
                        @else
                            @php $pic=$r->from->avatar @endphp
                            @php $id=$r->from->id; @endphp
                            @php $name=$r->from->first_name @endphp
                        @endif
                                ...
                                <div class="col-10 mymessage newmymessage p-0">
                                    <div class="row">
                                        ...
                                        <div class="col-4 col-sm-12 col-md-12 col-lg-4 messagetime pr-0" style="margin-left: 0; float:right;">
                                            <p> {{\Carbon\Carbon::parse($r->created_at)->diffForHumans()}}</p>
                                        </div>
...
<div class="col-8  othermessage p-0">
    <p>
        {{$m->message}}
{{--        <div class="row m-0 requestmessage" style="background: #e8ffe8;">--}}
{{--        <div class="col-6 pr-0 imagesection"><img src="{{config('app.ui_asset_url').'frontend/img/coverevents.jpg'}}" alt="Card image cap"></div>--}}
{{--        <div class="col-6 pl-0 content">User Friendly Ui</div>--}}
{{--    </div>--}}
    </p>
        ...
        <div class="col-12 mobilepdnig">
            <form class="send_m">
                <div class="form-row">
                    ...
                    <div class="form-group col-3 msgsndarea col-sm-3 col-md-2 col-lg-1 sendbtndiv"> <button value="submit" name="submit"  class="btn createofferbtn">Send</button></div>
                </div>
            </form>
