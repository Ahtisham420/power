          ...
          <form action="{{route('user-pass-change-submit')}}" method="post">
            ...
            <div class="col-12 input-button">
              <div class="input-group mb-3">
                ...
                <input type="email" name="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') ? old('email') : '' }}" required autocomplete="email" placeholder="Enter Your Email" aria-label="Username" aria-describedby="basic-addon1">
                @if ($errors->has('email'))
            ...
            <div class="col-12 input-button">
              <div class="input-group mb-3">
                ...
                <input type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="New Passsword" aria-label="Username" aria-describedby="basic-addon1" name="password" required autocomplete="current-password" value="{{ old('password') ? old('password') : '' }}">
